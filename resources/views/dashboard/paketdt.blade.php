                        ...
                        <div class="card-header pb-0">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="justify-content-end">
                                    <a class="btn btn-primary" href="{{ route('post.addpaket') }}"> Tambah</a>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex justify-align-center">
                                                        <img src="{{ asset('/images_paket') . '/' . $post->img_paket }}"
                                                ...
                                                <td class="align-middle text-center text-sm">
                                                    <p>{{ substr($post->deskripsi_paket, 0, 50) }}</p>
                                                </td>
                                                
                                                <td class="justify-content-center align-middle">
                                                    <a href="{{ route('post.editpaket', $post->id ) }}"
                                                        class="btn btn-info font-weight-bold text-xs mx-2"
                                                        >
                                                        Edit
                                                    </a>
                                                    <a href="{{ route('post.deletepaket', $post->id ) }}"
