                    ...
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            <div class="d-flex justify-content-between">
                                <h6>Data Foto Kegiatan</h6>
                                <div class="justify-content-end">
                                    <a class="btn btn-primary" href="{{ route('post.addkegiatan') }}"> Tambah</a>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex justify-align-center">
                                                        <img src="{{ asset('/images_kegiatan') . '/' . $post->img_kegiatan }}"
                                                ...
                                                <td class="justify-content-center align-middle">
                                                    <a href="{{ route('post.editkegiatan', $post->id ) }}"
                                                        class="btn btn-info font-weight-bold text-xs mx-2"
                                                        >
                                                        Edit
                                                    </a>
                                                    <a href="{{ route('post.deletekegiatan', $post->id ) }}"
